unit PizzaServer.Controllers.Pizza;
...
begin
  THorse
    ...
    begin
      ...
      Pizza.Librarys.EndPoint.AddRequest(req, res, 'api/v1/', 'pizzas');
      Res.Send(resultado);
    end
  );

  Pizza.Librarys.EndPoint.AddEndPoint('api/v1/', 'pizzas', [pmGet]);
end;
